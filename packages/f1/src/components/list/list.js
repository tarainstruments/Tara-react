// // ! MEANT TO ONLY DISPLAY POSTS FROM THE "products" CATEGORY
        ...
        <Container>
            ...
            {data.isAwsmJobOpeningsArchive && (
                <section className="section">
                    ...
                    <p>
                        {" "}
                        You can send your application to us, with a suitable
                        covering letter/email and a detailed CV by email to{" "}
                    ...
                    <p>
                        Please make it clear in your application the type of
                        role which interests you.{" "}
                    </p>
                    <p>
                        We aim to contact individuals who have applied
                        speculatively when a suitable role arises, but please
                        don’t hesitate to apply again at a later date if you see
                        a role you think is right for you.
                    </p>
                </section>
            )}
